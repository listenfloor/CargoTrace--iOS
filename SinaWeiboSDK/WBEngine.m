...
#define kWBURLSchemePrefix              @"WB_Efeight_"
...
- (id)initWithAppKey:(NSString *)theAppKey appSecret:(NSString *)theAppSecret
{
    if (self = [super init])
    {
        ...
        //self.redirectURI = @"http://www.efreight.cn";
...
- (void)logIn
{
    ...
    {
        [authorize setRedirectURI:@"http://www.efreight.cn"];
    }
                 ...
                 httpHeaderFields:(NSDictionary *)httpHeaderFields
{
    ...
    [[ActiveMaskView SharedIndicator] ShowInWindow];
}
...
- (void)getSNSFriends:(NSString *)cursor
{
    NSMutableDictionary *params = [NSMutableDictionary dictionaryWithCapacity:2];
    [params setObject:self.userID forKey:@"uid"];
    [params setObject:[NSString stringWithFormat:@"%d", 200] forKey:@"count"];
    [params setObject:[NSString stringWithFormat:@"%d", 0] forKey:@"cursor"];
