...
typedef enum{
    kTCWBRequestPostDataTypeNone,
	kTCWBRequestPostDataTypeNormal,		// for normal data post, such as "user=name&password=psd"
	kTCWBRequestPostDataTypeMultipart,    // for uploading images and files.
