...
- (void)viewDidLoad{
    ...
    webView = [[UIWebView alloc] initWithFrame:CGRectMake(0, 0, 320, self.view.frame.size.height - 44)];
    ...
    [indicatorView setCenter:CGPointMake(160, self.view.frame.size.height/2 - 30)];
